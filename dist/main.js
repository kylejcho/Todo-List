...
/* harmony export */   "isEvening": () => (/* binding */ isEvening),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
const isEvening = () => {
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date()) >= 18 || (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date()) <= 24){
        return true
    }
}
...
const createTasksContainer = (type) => {
    ...
    if (type == 'today') {
        ...
        if (type == 'home') {
            if (_dates__WEBPACK_IMPORTED_MODULE_2__.isMorning) {
                tasksContainerTitle.innerText = "Good Morning, Kyle.";
            } else if (_dates__WEBPACK_IMPORTED_MODULE_2__.isAfternoon) {
